 ...
 */
export declare function BrowserRouter({ children, timeout, window }: BrowserRouterProps): JSX.Element;
 ...
 */
export declare function HashRouter({ children, timeout, window }: HashRouterProps): JSX.Element;
