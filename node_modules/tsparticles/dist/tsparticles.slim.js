...
class Particle_Particle {
  constructor(container, position, overrideOptions) {
    ...
    const sizeValue = (_k = this.sizeValue) !== null && _k !== void 0 ? _k : container.retina.sizeValue;
...
class ImageDrawer_ImageDrawer {
  ...
  init(container) {
    ...
    return Object(tslib_es6["a" /* __awaiter */])(this, void 0, void 0, function* () {
      const options = container.options;
      const imageOptions = (_a = options.particles.shape.options[ShapeType["a" /* ShapeType */].images]) !== null && _a !== void 0 ? _a : options.particles.shape.options[ShapeType["a" /* ShapeType */].image];
  ...
  loadImageShape(container, imageShape) {
    return Object(tslib_es6["a" /* __awaiter */])(this, void 0, void 0, function* () {
      try {
        const image = yield Utils["a" /* Utils */].loadImage(imageShape.src);
